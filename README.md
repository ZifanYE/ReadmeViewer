...
To ensure fairness，these **open-source models** are allowed to use:
	...
	+ qwen1.5-32B [lmstudio-community/Qwen1.5-32B-Chat-GGUF](https://model.lmstudio.ai/download/lmstudio-community/Qwen1.5-32B-Chat-GGUF)  
	...
	+ If your computer can't afford these models, you can use other open-source models llama3.1-??
